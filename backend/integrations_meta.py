...
INTEGRATIONS: Dict[str, Dict[str, Any]] = {
    ...
    "google_business_profile": {
        ...
        "category": "Local SEO",
        "icon": "MapPin",
        "description": "GBP calls, direction requests, reviews, local visibility.",
        "fields": [
            {"key": "oauth_client_id", "label": "OAuth Client ID", "secret": True},
            {"key": "oauth_client_secret", "label": "OAuth Client Secret", "secret": True},
            {"key": "refresh_token", "label": "Refresh Token", "secret": True},
    ...
    "google_analytics": {
        ...
        "category": "Analytics",
        "icon": "ChartLine",
        "description": "Traffic, conversions, attribution, engagement.",
        "fields": [
            {"key": "oauth_client_id", "label": "OAuth Client ID", "secret": True},
            {"key": "oauth_client_secret", "label": "OAuth Client Secret", "secret": True},
            {"key": "refresh_token", "label": "Refresh Token", "secret": True},
            {"key": "property_id", "label": "GA4 Property ID", "secret": False},
        ],
    },
    "google_search_console": {
        ...
        "description": "Organic keywords, CTR, impressions, indexing.",
        "fields": [
            {"key": "oauth_client_id", "label": "OAuth Client ID", "secret": True},
            {"key": "oauth_client_secret", "label": "OAuth Client Secret", "secret": True},
            {"key": "refresh_token", "label": "Refresh Token", "secret": True},
            {"key": "site_url", "label": "Site URL", "secret": False, "help": "e.g. https://www.example.com/"},
        ],
    },
    "ahrefs": {
        "label": "Ahrefs",
    ...
    "google_lsa": {
        ...
        "category": "Paid Media",
        "icon": "Phone",
        "description": "LSA leads, calls, lead quality scoring.",
        "fields": [
            {"key": "oauth_client_id", "label": "OAuth Client ID", "secret": True},
            {"key": "oauth_client_secret", "label": "OAuth Client Secret", "secret": True},
            {"key": "refresh_token", "label": "Refresh Token", "secret": True},
            {"key": "manager_customer_id", "label": "Manager Customer ID", "secret": False},
        ],
    },
    "google_drive": {
        "label": "Google Drive",
        "category": "Documents",
        "icon": "FolderOpen",
        "description": "Onboarding forms, deliverables, photos, Google Meet recordings & transcripts.",
        "fields": [
            {"key": "oauth_client_id", "label": "OAuth Client ID", "secret": True},
            {"key": "oauth_client_secret", "label": "OAuth Client Secret", "secret": True},
            {"key": "refresh_token", "label": "Refresh Token", "secret": True},
            {"key": "client_folder_id", "label": "Client Root Folder ID", "secret": False},
        ],
    },
    "gmail": {
        "label": "Gmail",
        ...
        "icon": "Envelope",
        "description": "Communication history, unresolved threads, follow-up drafts.",
        "fields": [
            {"key": "oauth_client_id", "label": "OAuth Client ID", "secret": True},
            {"key": "oauth_client_secret", "label": "OAuth Client Secret", "secret": True},
            {"key": "refresh_token", "label": "Refresh Token", "secret": True},
    ...
    "google_meet": {
        ...
        "category": "Meetings",
        "icon": "VideoCamera",
        "description": "Auto-pull Meet recordings and Gemini-generated transcripts from Drive.",
        "fields": [
            {"key": "oauth_client_id", "label": "OAuth Client ID", "secret": True},
            {"key": "oauth_client_secret", "label": "OAuth Client Secret", "secret": True},
            {"key": "refresh_token", "label": "Refresh Token", "secret": True},
