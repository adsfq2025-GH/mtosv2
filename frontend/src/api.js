...
export const integrations = {
  ...
  oauthClickupStart: () => api.get("/oauth/clickup/start").then((r) => r.data),
  oauthClickupDisconnect: () => api.post("/oauth/clickup/disconnect").then((r) => r.data),
  oauthClickupStatus: () => api.get("/oauth/clickup/status").then((r) => r.data),
